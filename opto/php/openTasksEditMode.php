...
if($contagem != 0){
	mysqli_query($conexao, "DELETE FROM openTasksEditMode WHERE task_id = '$taskID' AND user_id = '$userID'");
}else{
	mysqli_query($conexao, "INSERT INTO openTasksEditMode (task_id, user_id)VALUES('$taskID', '$userID')");
}
echo 'ok';

...
if($contagem != 0){
	mysqli_query($conexao, "DELETE FROM openProjects WHERE project_id = '$projectID' AND user_id = '$userID'");
}else{
	mysqli_query($conexao, "INSERT INTO openProjects (project_id, user_id)VALUES('$projectID', '$userID')");
}
echo 'ok';
